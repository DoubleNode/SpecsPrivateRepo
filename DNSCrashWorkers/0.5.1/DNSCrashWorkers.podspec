Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/DoubleNode/Pod_DNSCrashWorkers"
  ...
  s.platform        = :ios, "11.0"
  s.source          = { :git => "git@github.com:DoubleNode/Pod_DNSCrashWorkers.git", :tag => "#{s.version}" }
  s.swift_version   = '5.1'
