Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/DoubleNode/Pod_DNSBlank_Workers"
  ...
  s.platform        = :ios, "11.0"
  s.source          = { :git => "https://github.com/DoubleNode/Pod_DNSBlank_Workers.git", :tag => "#{s.version}" }
  s.swift_version   = '5.1'
